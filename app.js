...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/myuntggame.loader.js";
var config = {
  dataUrl: buildUrl + "/myuntggame.data",
  frameworkUrl: buildUrl + "/myuntggame.framework.js",
  codeUrl: buildUrl + "/myuntggame.wasm",
  streamingAssetsUrl: "StreamingAssets",
  companyName: "DefaultCompany",
  productName: "Telegram Game",
  productVersion: "1.0"
};
